 ...
 import { Pill, User, Lock, ArrowRight, Shield, Activity, Package } from 'lucide-react';
 ...
 const roles: { id: UserRole; label: string; description: string; icon: typeof User }[] = [
   { id: 'admin', label: 'Administrator', description: 'Full system access', icon: Shield },
   { id: 'pharmacist', label: 'Pharmacist', description: 'Dispense & manage stock', icon: Activity },
   { id: 'auditor', label: 'Auditor', description: 'View-only access', icon: Package },
 ];
 ...
 export function LoginPage() {
   ...
   const handleSubmit = async (e: React.FormEvent) => {
     ...
     try {
       const success = await login(email || 'demo@clinic.ke', password || 'demo', selectedRole);
       if (!success) {
       ...
       >
         <div className="w-full max-w-md space-y-8">
           ...
           <div className="text-center lg:text-left">
             ...
             <p className="text-muted-foreground mt-2">Sign in to access the inventory system</p>
           </div>
